...
seat=seats(AI)
vacan=vacancies(AI)
vdf['Artificial Intelligence and Machine Learning']=vslashs(vacan,seat)
seat=seats(CS)
vacan=vacancies(CS)
vdf['Computer Science Engineering']=vslashs(vacan,seat)
seat=seats(EC)
vacan=vacancies(EC)
vdf['Electronics and Communication Engineering']=vslashs(vacan,seat)
seat=seats(ME)
vacan=vacancies(ME)
vdf['Mechanical Engineering']=vslashs(vacan,seat)
seat=seats(MA)
vacan=vacancies(MA)
vdf['Mechanical Automobile Engineering']=vslashs(vacan,seat)
seat=seats(BT)
vacan=vacancies(BT)
vdf['Biotechnology and Biochemical Engineering']=vslashs(vacan,seat)
seat=seats(CL)
vacan=vacancies(CL)
