...
st.pyplot(fig1)
st.subheader('Artificial Intelligence And Machine Learning\t- ',nAI)
print('Computer Science\t\t\t\t- ',nCS)
print('Electronics and Communication\t\t\t- ',nEC)
print('Mechanical\t\t\t\t\t- ',nME)
print('Mechanical Production\t\t\t\t- ',nMP)
print('Mechanical Automobile\t\t\t\t- ',nMA)
print('Biotechnology\t\t\t\t\t- ',nBT)
print('Civil\t\t\t\t\t\t- ',nCL)
