...
seats=seats(AI)
vacan=vacancies(AI)
vdf['Artificial Intelligence and Machine Learning']=vslashs(vacan,seats)
seats=seats(CS)
vacan=vacancies(CS)
vdf['Computer Science Engineering']=vslashs(vacan,seats)
seats=seats(EC)
vacan=vacancies(EC)
vdf['Electronics and Communication Engineering']=vslashs(vacan,seats)
seats=seats(ME)
vacan=vacancies(ME)
vdf['Mechanical Engineering']=vslashs(vacan,seats)
seats=seats(MA)
vacan=vacancies(MA)
vdf['Mechanical Automobile Engineering']=vslashs(vacan,seats)
seats=seats(BT)
vacan=vacancies(BT)
vdf['Biotechnology and Biochemical Engineering']=vslashs(vacan,seats)
seats=seats(CL)
vacan=vacancies(CL)
vdf['Civil Engineering']=vslashs(vacan,seats)
st.dataframe(vdf)
