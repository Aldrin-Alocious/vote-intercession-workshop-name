...
with tab1.form("my_form",clear_on_submit=True):
  ...
  st.session_state['opt']=st.radio('Pick one', ['Connect', 'Bridge', 'Kneel', 'Entreaty'])
  if st.session_state['opt']=='Connect':
  ...
  elif st.session_state['opt']=='Bridge':
